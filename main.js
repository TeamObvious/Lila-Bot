...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '𝐒𝐎𝐘 𝐋𝐈𝐋𝐀 𝐘 𝐓𝐄 𝐃𝐎𝐘 𝐋𝐀 𝐁𝐈𝐄𝐍𝐕𝐄𝐍𝐈𝐃𝐀 𝐀 𝐄𝐒𝐓𝐄 𝐆𝐑𝐔𝐏𝐎 @user 🌸';
  conn.bye = '𝐉𝐀 𝐒𝐄 𝐅𝐔𝐄, 𝐔𝐍 𝐏𝐄𝐒𝐎 𝐌𝐄𝐍𝐎𝐒 @user 🌸';
  conn.spromote = '𝐓𝐔 @user  𝐀𝐇𝐎𝐑𝐀 𝐄𝐑𝐄𝐒 𝐀𝐃𝐌𝐈𝐍 𝐃𝐄 𝐄𝐒𝐓𝐄 𝐆𝐑𝐔𝐏𝐎🌸';
  conn.sdemote = '𝐓𝐔 @user 𝐉𝐀𝐉𝐀𝐉𝐀 𝐀𝐇𝐎𝐑𝐀 𝐄𝐑𝐄𝐒 𝐔𝐍 𝐗 𝐌𝐀𝐒 𝐃𝐄𝐋 𝐆𝐑𝐔𝐏𝐎 🌸';
  conn.sDesc = '𝐋𝐀 𝐃𝐄𝐒𝐂𝐑𝐈𝐏𝐂𝐈Ó𝐍 𝐃𝐄𝐋 𝐆𝐑𝐔𝐏𝐎 𝐀𝐇𝐎𝐑𝐀 𝐄𝐒 𝐎𝐓𝐑𝐀, 𝐋𝐄𝐄𝐋𝐀 🌸';
  conn.sSubject = '𝐒𝐄 𝐇𝐀 𝐂𝐀𝐌𝐁𝐈𝐀𝐃𝐎 𝐄𝐋 𝐍𝐎𝐌𝐁𝐑𝐄 𝐃𝐄𝐋 𝐆𝐑𝐔𝐏𝐎 🌸';
  conn.sIcon = '𝐒𝐄 𝐇𝐀 𝐂𝐀𝐌𝐁𝐈𝐀𝐃𝐎 𝐋𝐀 𝐅𝐎𝐓𝐎 𝐃𝐄 𝐏𝐄𝐑𝐅𝐈𝐋 𝐃𝐄𝐋 𝐆𝐑𝐔𝐏𝐎 🌸';
  conn.sRevoke = '𝐄𝐋 𝐄𝐍𝐋𝐀𝐂𝐄 𝐃𝐄 𝐈𝐍𝐕𝐈𝐓𝐀𝐂𝐈𝐎𝐍 𝐒𝐄 𝐇𝐀 𝐑𝐄𝐒𝐓𝐀𝐁𝐋𝐄𝐂𝐈𝐃𝐎🌸';
...
setInterval(async () => {
  ...
  const bio = `𝐇𝐨𝐥𝐚 𝐬𝐨𝐲 𝐥𝐢𝐥𝐚 𝐲 𝐞𝐬𝐭á𝐬 𝐯𝐢𝐞𝐧𝐝𝐨 𝐦𝐢 𝐩𝐞𝐫𝐟𝐢𝐥 🌸`;
